...
##Code for UNet
class UNetGrad(LIONmodel.LIONmodel):
    def __init__(self, model_parameters=None):
        # set properties of UNet
        if model_parameters is None:
            model_parameters = UNetGrad.default_parameters()
        super().__init__(model_parameters)
        #inChan, outChan, noGrp, dropFac, name
        ...
        self.baseconv = nn.Conv2d(model_parameters.baseDim * 16, 1, 3)
    ...
    def forward(self, x):
        ...
        enc1 = self.encoder1(mod_inp.cuda())
        ...
        return self.baseconv(base),self.conv(dec1)
