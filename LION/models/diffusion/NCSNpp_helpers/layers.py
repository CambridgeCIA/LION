...
# and their codebase at https://github.com/yang-song/score_sde_pytorch/models/layers.py
...
def get_act(params):
    ...
    if params.nonlinearity.lower() == "elu":
        return nn.ELU()
    elif params.nonlinearity.lower() == "relu":
        return nn.ReLU()
    elif params.nonlinearity.lower() == "lrelu":
        return nn.LeakyReLU(negative_slope=0.2)
    elif params.nonlinearity.lower() == "swish":
        return nn.SiLU()
    else:
