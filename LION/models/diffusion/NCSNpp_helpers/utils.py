...
# and their codebase at https://github.com/yang-song/score_sde_pytorch/models/utils.py
...
def get_sigmas(params):
    ...
    sigmas = np.exp(
        np.linspace(
            np.log(params.sigma_max), np.log(params.sigma_min), params.num_scales
        )
    )
