...
final_result_fname = savefolder.joinpath("FBPMSDNet_Limited60.pt")
checkpoint_fname = "FBPMSDnet_Limited60_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("FBPMSDnet_Limited60_min_val.pt")
...
plt.savefig("loss_FBPMSDNet_Limited60.png")
