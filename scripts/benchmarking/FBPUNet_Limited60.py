...
final_result_fname = savefolder.joinpath("FBPUNet_Limited60.pt")
checkpoint_fname = "FBPUnet_Limited60_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("FBPUnet_Limited60_min_val.pt")
...
plt.savefig("loss_FBPUNet_Limited60.png")
