...
final_result_fname = savefolder.joinpath("LG_BeamHardening.pt")
checkpoint_fname = "LG_BeamHardening_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("LG_BeamHardening_min_val.pt")
...
plt.savefig("loss_LG_BeamHardening.png")
