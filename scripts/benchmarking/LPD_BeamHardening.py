...
final_result_fname = savefolder.joinpath("LPD_BeamHardening.pt")
checkpoint_fname = "LPD_BeamHardening_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("LPD_BeamHardening_min_val.pt")
...
plt.savefig("loss_LPD_BeamHardening.png")
