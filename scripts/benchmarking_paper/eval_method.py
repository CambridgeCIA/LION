...
def eval_experiment(evaluation):
    ...
    plt.savefig(
        fig_folder.joinpath(
            f"eval_best_psnr_{evaluation['method_name']}_{evaluation['checkpoint']}.png"
        ),
        dpi=300,
    )
    ...
    plt.savefig(
        fig_folder.joinpath(
            f"eval_worst_psnr_{evaluation['method_name']}_{evaluation['checkpoint']}.png"
        ),
        dpi=300,
    )
    del target, data, recon, output
    ...
    plt.savefig(
        fig_folder.joinpath(
            f"eval_mean_psnr_{evaluation['method_name']}_{evaluation['checkpoint']}.png"
        ),
        dpi=300,
    )
