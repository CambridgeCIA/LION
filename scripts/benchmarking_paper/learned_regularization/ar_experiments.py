...
def train_experiment(experiment,savefolder):
    ...
    final_result_fname = savefolder.joinpath("AR" + experiment.__class__.__name__ + ".pt")
    checkpoint_fname = "AR" + experiment.__class__.__name__ + "_check_*.pt"  # if you use LION checkpoiting, remember to have wildcard (*) in the filename
    validation_fname = savefolder.joinpath("AR" + experiment.__class__.__name__ +"_min_val.pt")
