...
def plot_supplementary_neuroIPS(
    recon: list,
    gt: list,
    indices: list,
    model_name: str,
    ...
    for i in range(3):  # best/worst/mean
        ...
        plt.title(
            f"SSIM: {ssim(gt[i],recon[i],data_range=gt[i].max()-gt[i].min()):.2f}"
        )
        plt.axis("off")
        plt.clim(0, max_val)
        ...
        cb_ax = fig.add_axes([0.2, 0.08, 0.6, 0.012])
    ...
    plt.savefig(
        example_folder.joinpath(f"eval_{model_name}_{experiment_name}.png"),
        dpi=300,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def eval_experiment(evaluation, indices_eval=128):
    ...
    plot_supplementary_neuroIPS(
        outputs, gts, indices, evaluation["algo_name"], evaluation["experiment_name"]
    )
...
if __name__ == "__main__":
    ...
    evaluations += [
        dict(
            ...
            method_name="TDV_best",
            method=TDV,
            experiment=ct_benchmarking.FullDataCTRecon(),
            checkpoint="TDVFullDataCTRecon_check_0008.pt",
        ),
        dict(
            algo_name="TDV",
            experiment_name="Limited120",
            method_name="TDV_best",
            method=TDV,
            experiment=ct_benchmarking.LimitedAngle120CTRecon(),
            checkpoint="TDVLimitedAngle120CTRecon_check_0004.pt",
        ),
        dict(
            algo_name="TDV",
            experiment_name="Limited90",
            method_name="TDV_best",
            method=TDV,
            experiment=ct_benchmarking.LimitedAngle90CTRecon(),
            checkpoint="TDVLimitedAngle90CTRecon_check_0011.pt",
        ),
        dict(
            algo_name="TDV",
            experiment_name="Limited60",
            method_name="TDV_best",
            method=TDV,
            experiment=ct_benchmarking.LimitedAngle60CTRecon(),
            checkpoint="TDVLimitedAngle60CTRecon_check_0011.pt",
        ),
        dict(
            algo_name="TDV",
            experiment_name="LowDose",
            method_name="TDV_best",
            method=TDV,
            experiment=ct_benchmarking.LowDoseCTRecon(),
            checkpoint="TDVLowDoseCTRecon_check_0006.pt",
        ),
        dict(
            algo_name="TDV",
            experiment_name="Sparse360",
            method_name="TDV_best",
            method=TDV,
            experiment=ct_benchmarking.SparseAngle360CTRecon(),
            checkpoint="TDVSparseAngle360CTRecon_check_0011.pt",
        ),
        dict(
            algo_name="TDV",
            experiment_name="Sparse120",
            method_name="TDV_best",
            method=TDV,
            experiment=ct_benchmarking.SparseAngle120CTRecon(),
            checkpoint="TDVSparseAngle120CTRecon_check_0011.pt",
        ),
        dict(
            algo_name="TDV",
            experiment_name="Sparse60",
            method_name="TDV_best",
            method=TDV,
            experiment=ct_benchmarking.SparseAngle60CTRecon(),
            checkpoint="TDVSparseAngle60CTRecon_check_0011.pt",
        ),
        dict(
            algo_name="TDV",
            experiment_name="BeamHardening",
            method_name="TDV_best",
            method=TDV,
            experiment=ct_benchmarking.BeamHardeningCTRecon(),
            checkpoint="TDVBeamHardeningCTRecon_check_0004.pt",
        ),
    ]
    ...
    evaluations += [
        dict(
            ...
            method=AR,
            experiment=ct_benchmarking.FullDataCTRecon(),
            checkpoint="ARFullDataCTRecon_check_0017.pt",
        ),
        dict(
            algo_name="AR",
            experiment_name="Limited120",
            ...
            method=AR,
            experiment=ct_benchmarking.LimitedAngle120CTRecon(),
            checkpoint="ARLimitedAngle120CTRecon_check_0008.pt",
        ),
        dict(
            algo_name="AR",
            experiment_name="Limited90",
            ...
            method=AR,
            experiment=ct_benchmarking.LimitedAngle90CTRecon(),
            checkpoint="ARLimitedAngle90CTRecon_check_0003.pt",
        ),
        dict(
            algo_name="AR",
            experiment_name="Limited60",
            ...
            method=AR,
            experiment=ct_benchmarking.LimitedAngle60CTRecon(),
            checkpoint="ARLimitedAngle60CTRecon_check_0025.pt",
        ),
        dict(
            algo_name="AR",
            experiment_name="LowDose",
            ...
            method=AR,
            experiment=ct_benchmarking.LowDoseCTRecon(),
            checkpoint="ARLowDoseCTRecon_check_0003.pt",
        ),
        dict(
            algo_name="AR",
            experiment_name="Sparse360",
            ...
            method=AR,
            experiment=ct_benchmarking.SparseAngle360CTRecon(),
            checkpoint="ARSparseAngle360CTRecon_check_0009.pt",
        ),
        dict(
            algo_name="AR",
            experiment_name="Sparse120",
            ...
            method=AR,
            experiment=ct_benchmarking.SparseAngle120CTRecon(),
            checkpoint="ARSparseAngle120CTRecon_check_0003.pt",
        ),
        dict(
            algo_name="AR",
            experiment_name="Sparse60",
            ...
            method=AR,
            experiment=ct_benchmarking.SparseAngle60CTRecon(),
            checkpoint="ARSparseAngle60CTRecon_check_0025.pt",
        ),
        dict(
            algo_name="AR",
            experiment_name="BeamHardening",
            ...
            method=AR,
            experiment=ct_benchmarking.BeamHardeningCTRecon(),
            checkpoint="ARBeamHardeningCTRecon_check_0023.pt",
        ),
    ]
    indices_eval += [
        (205, 203, 122),
    ...
    evaluations += [
        dict(
            algo_name="ACR",
            experiment_name="FullData",
            method_name="ACR_best",
            method=ACR,
            experiment=ct_benchmarking.FullDataCTRecon(),
            checkpoint="ACRFullDataCTRecon_check_0025.pt",
        ),
        dict(
            algo_name="ACR",
            experiment_name="Limited120",
            ...
            method=ACR,
            experiment=ct_benchmarking.LimitedAngle120CTRecon(),
            checkpoint="ACRLimitedAngle120CTRecon_check_0009.pt",
        ),
        dict(
            algo_name="ACR",
            experiment_name="Limited90",
            ...
            method=ACR,
            experiment=ct_benchmarking.LimitedAngle90CTRecon(),
            checkpoint="ACRLimitedAngle90CTRecon_check_0010.pt",
        ),
        dict(
            algo_name="ACR",
            experiment_name="Limited60",
            ...
            method=ACR,
            experiment=ct_benchmarking.LimitedAngle60CTRecon(),
            checkpoint="ACRLimitedAngle60CTRecon_check_0004.pt",
        ),
        dict(
            algo_name="ACR",
            experiment_name="LowDose",
            ...
            method=ACR,
            experiment=ct_benchmarking.LowDoseCTRecon(),
            checkpoint="ACRLowDoseCTRecon_check_0024.pt",
        ),
        dict(
            algo_name="ACR",
            experiment_name="Sparse360",
            ...
            method=ACR,
            experiment=ct_benchmarking.SparseAngle360CTRecon(),
            checkpoint="ACRSparseAngle360CTRecon_check_0024.pt",
        ),
        dict(
            algo_name="ACR",
            experiment_name="Sparse120",
            ...
            method=ACR,
            experiment=ct_benchmarking.SparseAngle120CTRecon(),
            checkpoint="ACRSparseAngle120CTRecon_check_0023.pt",
        ),
        dict(
            algo_name="ACR",
            experiment_name="Sparse60",
            ...
            method=ACR,
            experiment=ct_benchmarking.SparseAngle60CTRecon(),
            checkpoint="ACRSparseAngle60CTRecon_check_0023.pt",
        ),
        dict(
            algo_name="ACR",
            experiment_name="BeamHardening",
            ...
            method=ACR,
            experiment=ct_benchmarking.BeamHardeningCTRecon(),
            checkpoint="ACRBeamHardeningCTRecon_check_0025.pt",
        ),
    ]
    indices_eval += [
        (205, 35, 122),
    ...
    for evaluation, indices in zip(evaluations, indices_eval):
        ...
        eval_experiment(
            evaluation, indices_eval=torch.tensor((indices[0], indices[2], indices[1]))
        )  # was ordered as best mean worst, but for plotting its best worst mean
...
def plot_supplementary_neuroIPS(
    ...
    for i in range(3):  # best/worst/mean
        ...
        cbar.ax.tick_params(labelsize=10)
    plt.savefig(
        f"eval_{model_name}_{experiment_name}.png",
        dpi=300,
        bbox_inches="tight",
        pad_inches=0,
    )
