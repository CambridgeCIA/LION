...
```bash
scripts/paper_scripts/PaDIS-Reproduction/reconstruction/PaDIS_LIDC_reconstruction.py
```
...
```bash
scripts/paper_scripts/PaDIS-Reproduction/tuning/PaDIS_tune_reconstruction_hyperparameters.py
```
...
```bash
bash scripts/paper_scripts/PaDIS-Reproduction/tuning/run_fixedval_reconstruction_tuning.sh
```
...
```bash
bash scripts/paper_scripts/PaDIS-Reproduction/tuning/run_fixedval_public_paper_tuning.sh
```
...
```bash
bash scripts/paper_scripts/PaDIS-Reproduction/tuning/run_lion_physics_solver_pc_followup.sh
```
...
```bash
bash scripts/paper_scripts/PaDIS-Reproduction/tuning/run_paper_public_consensus_tuning.sh
```
...
/home/thomas/anaconda3/envs/lion-dev/bin/python -u scripts/paper_scripts/PaDIS-Reproduction/reconstruction/PaDIS_LIDC_reconstruction.py \
...
```bash
python scripts/paper_scripts/PaDIS-Reproduction/core/PaDIS_experiments.py \
...
```bash
scripts/paper_scripts/PaDIS-Reproduction/pipeline/run_prepare_lidc_cache.sh
```
...
```bash
scripts/paper_scripts/PaDIS-Reproduction/platforms/slurm/submit_PaDIS_A100_training_only.sh
```
...
`/mnt/data/LION/scripts/paper_scripts/PaDIS-Reproduction/platforms/gcp/padis_gcp_spot_startup.sh`.
...
```bash
scripts/paper_scripts/PaDIS-Reproduction/training/PaDIS_LIDC_PnP_denoiser.py
```
...
conda run --no-capture-output -n lion-dev env \
  ...
  python scripts/paper_scripts/PaDIS-Reproduction/training/PaDIS_LIDC_PnP_denoiser.py \
...
conda run --no-capture-output -n lion-dev env \
  ...
  XDG_CACHE_HOME=/tmp/padis-xdg \
  PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True \
  python scripts/paper_scripts/PaDIS-Reproduction/training/PaDIS_LIDC_256.py \
...
```bash
conda run --no-capture-output -n lion-dev python scripts/paper_scripts/PaDIS-Reproduction/training/PaDIS_LIDC_PnP_denoiser.py \
...
```bash
conda run --no-capture-output -n lion-dev python scripts/paper_scripts/PaDIS-Reproduction/reconstruction/PaDIS_LIDC_reconstruction.py \
...
After the jobs from
`scripts/paper_scripts/PaDIS-Reproduction/platforms/slurm/submit_PaDIS_A100_all_training.sh` have
...
conda run --no-capture-output -n lion-dev env \
  PYTHONPATH=/home/thomas/DiS/Project/LION \
  python scripts/paper_scripts/PaDIS-Reproduction/reconstruction/PaDIS_verify_reconstruction_matrix.py \
  --root "$OUT_ROOT" \
