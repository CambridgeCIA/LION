...
# GCP uses the ordinary patch-training default for p=96. The Slurm backend
# separately caps this task at 96 through padis_a100_common.sh for A100
# stability; that platform-specific cap must not leak into GCP runs.
PADIS_P96_BATCH_SIZE="${PADIS_GCP_P96_BATCH_SIZE:-${PADIS_P96_BATCH_SIZE:-128}}"
PADIS_P96_A100_BATCH_LIMIT="${PADIS_GCP_P96_BATCH_LIMIT:-128}"
