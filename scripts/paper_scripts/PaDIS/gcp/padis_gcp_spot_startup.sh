...
ensure_lion_root() {
        if [ ! -x "$LION_ROOT/scripts/paper_scripts/PaDIS/gcp/run_PaDIS_GCP_spot_training.sh" ]; then
...
RUNNER_PATH="$LION_ROOT/scripts/paper_scripts/PaDIS/gcp/run_PaDIS_GCP_spot_training.sh"
