...
for index in slice_indices:
    slice_name = str(savepath+"NoisyRecon_ExpNoise_test_slice"+str(index)+".npy")
    slice_names.append(slice_name)
    slice_name = str(savepath+"GTRecon_ExpNoise_test_slice"+str(index)+".npy")
    slice_names.append(slice_name)
...
plot_imgs(
    ...
    vmax=0.010,
    width=20,
    savename = "/export/scratch3/mbk/LION/noise_slices/Qualitative_Analysis_Reference_Figure_NoisePaper.pdf"
)
...
plt.savefig("/export/scratch3/mbk/LION/noise_slices/Qualitative_Analysis_Reference_Figure_NoisePaper.pdf", dpi=300)
