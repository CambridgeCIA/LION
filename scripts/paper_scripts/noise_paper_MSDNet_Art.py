...
final_result_fname = savefolder.joinpath("MSD_ArtNoise.pt")
checkpoint_fname = "MSD_ArtNoise_check_*.pt"  # if you use LION checkpointing, remember to have wildcard (*) in the filename
validation_fname = savefolder.joinpath("MSD_ArtNoise_min_val.pt")
...
plt.savefig("loss_MSD_ArtNoise.png")
