...
final_result_fname = savefolder.joinpath("UNet_ExpNoise.pt")
checkpoint_fname = "UNet_ExpNoise_check_*.pt"  # if you use LION checkpointing, remember to have wildcard (*) in the filename
validation_fname = "UNet_ExpNoise_min_val.pt"
...
plt.savefig("loss_UNet_ExpNoise.png")
